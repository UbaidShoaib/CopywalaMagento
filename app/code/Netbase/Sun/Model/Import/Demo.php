 ...
 */
namespace Netbase\Sun\Model\Import;
...
class Demo
{
    ...
    public function __construct(
        ...
        $this->_importPath = BP . '/app/code/Netbase/Sun/etc/import/';
    ...
    public function importDemo($demo_version,$store=NULL,$website = NULL)
    {
        ...
        try {
            ...
            if ($gatewayResponse->getIsValid()) {
                $gatewayResponse->setRequestMessage(__('Import '.$demo_version.' Successfuly'));
            } else {
