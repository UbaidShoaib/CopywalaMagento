...
/**
 * Brandcategory data helper
 */
namespace Cmsmart\Brandcategory\Helper;
...
{
    /**
     * Path to store config where count of brandcategory posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'brandcategory/view/items_per_page';
     ...
     * @var string
     */
    const MEDIA_PATH    = 'Brandcategory';
    ...
    /**
     * Remove Brandcategory item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Cmsmart\Brandcategory\Model\Brandcategory $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Brandcategory Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Brandcategory Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getBrandcategoryPerPage()
    {
    ...
    {
        return $this->scopeConfig->getValue("brandcategory/view/categories", \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
}
