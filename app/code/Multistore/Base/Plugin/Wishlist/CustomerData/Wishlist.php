...
namespace Multistore\Base\Plugin\Wishlist\CustomerData;
...
class Wishlist
{
    ...
    /**
     * @var \Multistore\Base\Helper\Data
     */
     ...
     * @param \Multistore\Base\Helper\Data $helperBase
     */
    public function __construct(
        ...
        \Multistore\Base\Helper\Data $helperBase
    ) {
    ...
    protected function getItemData(\Magento\Wishlist\Model\Item $wishlistItem)
    {
        ...
        return [
            ...
            'is_enable_call_for_price' => $this->_helperBase->checkIsCallForPrice($product),
            'button_call_for_price' => $this->_helperBase->getButtonCallForPriceHtml($product)
        ];
    }
