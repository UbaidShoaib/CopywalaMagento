...
class DeliveryDate
{
    ...
    public function getDeliveryDays()
    {
        $days = $this->scopeConfig->getValue(
            'netbaseteam_onestepcheckout/delivery_date/available_days', ScopeInterface::SCOPE_STORE
        );
    ...
    public function getDeliveryHours()
    {
        $hoursSetting = trim($this->scopeConfig->getValue(
            'netbaseteam_onestepcheckout/delivery_date/available_hours', ScopeInterface::SCOPE_STORE
        ));
