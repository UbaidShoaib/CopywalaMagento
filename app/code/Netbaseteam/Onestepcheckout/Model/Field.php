...
class Field extends AbstractModel
{
    ...
    public function __construct(
        ...
        \Netbaseteam\Onestepcheckout\Model\ResourceModel\Field $resource,
        \Netbaseteam\Onestepcheckout\Model\ResourceModel\Field\Collection $resourceCollection,
        \Netbaseteam\Onestepcheckout\Model\ResourceModel\Field\CollectionFactory $attributeCollectionFactory,
        array $data = []
    ) {
    ...
    {
        $this->_init('Netbaseteam\Onestepcheckout\Model\ResourceModel\Field');
    }
    ...
    {
        /** @var \Netbaseteam\Onestepcheckout\Model\ResourceModel\Field\Collection $collection */
