...
define([
    ...
    function amazonOriginalAction(paymentData, redirectOnSuccess, messageContainer, netbaseteamCheckoutData)
    {
        ...
        payload.amcheckout = netbaseteamCheckoutData;

        netbaseteamCheckoutData.forEach(function (item) {
