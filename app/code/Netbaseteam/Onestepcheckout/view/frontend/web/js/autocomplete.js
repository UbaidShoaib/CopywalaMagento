                ...
                switch (addressType) {
                    ...
                    case 'administrative_area_level_2':
                        ...
                        if (stateSelect && stateSelect.visible()) {
                            ...
                            if (country in window.netbaseteam_onestepcheckout_regions && value in window.netbaseteam_onestepcheckout_regions[country]) {
                                stateSelect.value(window.netbaseteam_onestepcheckout_regions[country][value]);
                            }
                        }
