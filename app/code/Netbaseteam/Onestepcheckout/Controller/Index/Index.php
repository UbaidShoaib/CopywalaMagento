...
namespace Netbaseteam\Onestepcheckout\Controller\Index;
...
class Index extends \Magento\Checkout\Controller\Index\Index
{
    ...
    public function execute()
    {
        ...
        if ($font = $this->scopeConfig->getValue('netbaseteam_onestepcheckout/design/font', ScopeInterface::SCOPE_STORE)) {
        ...
        $resultPage->getLayout()->getUpdate()->addHandle('netbaseteam_onestepcheckout');

        if ($this->scopeConfig->getValue('netbaseteam_onestepcheckout/design/header_footer', ScopeInterface::SCOPE_STORE)) {
        ...
        $checkoutBlock
            ->setTemplate('Netbaseteam_Onestepcheckout::onepage.phtml')
