<?php
namespace Netbaseteam\Onlinedesign\Block\Adminhtml\Catfont;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        if ($this->_coreRegistry->registry('catfont')->getId()) {
            return __("Edit Category '%1'", $this->escapeHtml($this->_coreRegistry->registry('catfont')->getTitle()));
        } else {
