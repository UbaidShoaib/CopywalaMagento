...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended {
	...
	public function __construct(
		...
		\Netbaseteam\Onlinedesign\Model\ResourceModel\Catfont\CollectionFactory $collectionFactory,
		array $data = []
	) {
	...
	protected function _prepareMassaction() {
		...
		$this->getMassactionBlock()->setFormFieldName('catfont_id');
