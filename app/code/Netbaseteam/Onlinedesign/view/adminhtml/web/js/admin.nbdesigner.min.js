...
var NBDESIGNADMIN = {
    add_font_cat: function (e) {
        ...
        jQuery.ajax({
            ...
            if (data.flag == 1) {
                ...
                /* html += '<script>require(["jquery","jquery/ui","evol-color"], function ($) {$( document ).ready(function() {$(".nbd-color-picker").colorpicker();});});</script>'; */
    ...
    add_google_font: function (e) {
        jQuery("#add-google-fonts").attr("disabled", true);
        var name = jQuery("#nbdesigner_google_font_seach").val() /* jQuery(e).prev('input').val() */,
        ...
        jQuery("#nbdesigner_container_list_google_font span a span").each(function(index, elem){
            if(jQuery.trim(name) === jQuery.trim(jQuery(this).text())){
                alert("This font exists. Please enter other font");
                _font_exists = true;
                jQuery("#add-google-fonts").attr("disabled", false);
                return false;
            }
        });
    ...
    resetBoxes: function (command) {
        ...
        jQuery.each(jQuery(index + ' .nbdesigner-box-container'), function (key, val) {
            ...
            jQuery(this).find('.hidden_nbd_include_background').attr('name', name + '[' + key + '][include_background]');
            jQuery(this).find('.hidden_nbd_include_overlay').attr('name', name + '[' + key + '][include_overlay]');
            jQuery(this).find('.hidden_nbd_show_bleed').attr('name', name + '[' + key + '][show_bleed]');
            jQuery(this).find('.hidden_nbd_bleed_top_bottom').attr('name', name + '[' + key + '][bleed_top_bottom]');
            jQuery(this).find('.hidden_nbd_bleed_left_right').attr('name', name + '[' + key + '][bleed_left_right]');
            jQuery(this).find('.hidden_nbd_show_safe_zone').attr('name', name + '[' + key + '][show_safe_zone]');
            jQuery(this).find('.hidden_nbd_margin_top_bottom').attr('name', name + '[' + key + '][margin_top_bottom]');
            jQuery(this).find('.hidden_nbd_margin_left_right').attr('name', name + '[' + key + '][margin_left_right]');
        });
    ...
    init_color_picker: function(){
        ...
        jQuery.each(jQuery('.nbd-color-picker'), function (elem) {
            jQuery(this).bind("change keyup input",function() {
                var $input = jQuery(this);
                setTimeout(function () {
...
require([
    ...
    jQuery(document).ready(function ($) {
        ...
        if ($('#onlinedesign_main_temp_show_on_online_design_page').val() == 1) {
            $("#onlinedesign_main_temp_show_on_online_design_page").trigger('click');
            $('#onlinedesign_main_temp_show_on_online_design_page').toggleClass('is_show_online_design_page');

            if($('#onlinedesign_main_temp_show_on_online_design_page').hasClass("is_show_online_design_page")){
                $('#onlinedesign_main_temp_show_on_online_design_page').val('1');
            } else {
                $('#onlinedesign_main_temp_show_on_online_design_page').val('0');
            }
        }

        $('#onlinedesign_main_temp_show_on_online_design_page').click(function () {
            $(this).toggleClass('is_show_online_design_page');
        ...
        if (typeof collapseAll !== 'undefined' && $.isFunction(collapseAll)) {
        ...
        $('#_nbdesigner_enable').change(function () {
            ...
            $('#nbdesigner_upload_design').toggleClass('nbdesigner-disable');
