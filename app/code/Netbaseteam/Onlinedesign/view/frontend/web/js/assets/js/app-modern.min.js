...
//                if( angular.isDefined( window.nbOption ) && angular.isDefined( window.nbOption.variations ) && window.nbOption.variations.length > 0 ){
//                    $scope.resource.config.variations = [];
//                    angular.copy(window.nbOption.variations, $scope.resource.config.variations);
//                }else{
...
//            }, 100);
    ...
    $scope.changePrintingOptions = function( first, initVariationSetting ){
        ...
        if( angular.isDefined( window.nbOption ) ){
            ...
            if( angular.equals( window.nbOption.odOption, $scope.lastPrintingOptions ) ){
            }else{
                angular.copy( window.nbOption.odOption, $scope.lastPrintingOptions );
            }
            var data = window.nbOption.odOption;
    ...
    $scope.saveData = function(type){
        ...
        if( angular.isUndefined( type ) && angular.isDefined( window.nbOption ) && angular.isDefined( window.nbOption.odOption ) 
            ...
            if(NBDESIGNCONFIG.show_nbo_option == "1" && NBDESIGNCONFIG.task == 'new' && NBDESIGNCONFIG.task2 == '' ){
                ...
                var interval = setInterval(function () {
                    if (jQuery('#nbo-options-wrap .page.messages a').length) {
...
function receiveMessage(event){
    if( event.origin == window.location.origin ){
        ...
        if( event.data == 'change_nbo_options' ){
            ...
            if( angular.isUndefined(window.nbOption) ) scope.changePrintingOptions();
            //nbdPostMessage();
