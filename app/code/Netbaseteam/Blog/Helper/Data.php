...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    */
    ...
    public function resizeImg($image,$type = 'default', $width, $height)
    {
        if ($type=='feature_image') {
             $absolutePath = $this->filesystem->getDirectoryRead(\Magento\Framework\App\Filesystem\DirectoryList::MEDIA)->getAbsolutePath('blog/feature_image/').$image;
        }else{
