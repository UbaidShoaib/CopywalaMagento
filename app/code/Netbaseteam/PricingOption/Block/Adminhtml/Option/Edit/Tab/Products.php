...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param OptionFactory $attachmentFactory
    ...
    {
        $collection = $this->productCollectionFactory->create()->addFieldToFilter('type_id',array('neq' => 'grouped'));
    ...
    {
        $model = $this->_objectManager->get('\Netbaseteam\PricingOption\Model\Option');
        $this->addColumn(
            'in_product',
            [
    ...
    protected function _getSelectedProducts()
    {
        ...
        $productIds = unserialize($option->getProductIds());
        return $productIds;
    }
    /**
    ...
    {
        $option = $this->getOption();
        $selected = unserialize($option->getProductIds());
