...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set($this->getThemeconfig()->getTitle());
    }
    ...
    {
        return $this->_coreRegistry->registry('current_themeconfig');
    }
    ...
    {
        return $this->getUrl('themeconfig/index/index');
    }
