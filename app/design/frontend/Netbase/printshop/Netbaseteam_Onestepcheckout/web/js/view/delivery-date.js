define(
    [
        ...
        'Netbaseteam_Onestepcheckout/js/action/update-delivery',
        'Netbaseteam_Onestepcheckout/js/model/delivery',
        'mage/translate',
        'Netbaseteam_Onestepcheckout/js/view/checkout/datepicker'
    ],
    function (
        $,
        Component,
        ...
        return Component.extend({
            defaults: {
                template: 'Netbaseteam_Onestepcheckout/checkout/delivery_date',
                listens: {
                    'update': 'update'
                }
            },
